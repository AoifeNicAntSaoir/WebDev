...
{
echo("<p style='text-align: center;'>You did not complete the add a book form correctly <br> <a style='color: orange; font-weight: bold; text-shadow: 1px 1px gray;' href='add-a-book.html'>Try Again?</a><br><br></p> <img style='height: 300px; margin-left: 30%;' src='images/error.png'>");
exit();    
}
else
{
$config = parse_ini_file("../../bookshopConfig");
...
$dbcnx = mysqli_connect($host, $username, $password, $database);  
//checkconnection
...
if ($res == 0) 
      ...
      {
	echo("<p style='text-align: center;'> Your book has been added! <br> <a style='color: orange; font-weight: bold; text-shadow: 1px 1px gray;' href='add-a-book.html'> Click here to enter another book </a></p><br> <img style='height: 300px; margin-left: 30%;' src='images/tick.png'>");
      }
}mysqli_close($dbcnx);
}	
